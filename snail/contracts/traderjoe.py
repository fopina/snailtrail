...
CONTRACT = '0xb4315e873dbcf96ffd0acd8ea43f689d8c20fb30'

ABI = [
    {
        'inputs': [
            {'internalType': 'contract ILBFactory', 'name': 'factory', 'type': 'address'},
            {'internalType': 'contract IJoeFactory', 'name': 'factoryV1', 'type': 'address'},
            {'internalType': 'contract ILBLegacyFactory', 'name': 'legacyFactory', 'type': 'address'},
            {'internalType': 'contract ILBLegacyRouter', 'name': 'legacyRouter', 'type': 'address'},
    ...
    {
        'inputs': [{'internalType': 'uint256', 'name': 'amountSlippage', 'type': 'uint256'}],
    ...
    },
    {
        ...
        'name': 'createLBPair',
        'outputs': [{'internalType': 'contract ILBPair', 'name': 'pair', 'type': 'address'}],
        'stateMutability': 'nonpayable',
        'type': 'function',
    },
    {
        'inputs': [],
        'name': 'getFactory',
        'outputs': [{'internalType': 'contract ILBFactory', 'name': 'lbFactory', 'type': 'address'}],
    ...
    },
    {
        ...
        'outputs': [{'internalType': 'contract ILBLegacyFactory', 'name': 'legacyLBfactory', 'type': 'address'}],
        'stateMutability': 'view',
        'type': 'function',
    },
    {
        ...
        'outputs': [{'internalType': 'contract ILBLegacyRouter', 'name': 'legacyRouter', 'type': 'address'}],
        'stateMutability': 'view',
        'type': 'function',
    },
    {
    ...
    },
    {
        'inputs': [],
        'name': 'getV1Factory',
        'outputs': [{'internalType': 'contract IJoeFactory', 'name': 'factoryV1', 'type': 'address'}],
        'stateMutability': 'view',
        'type': 'function',
    },
    {
